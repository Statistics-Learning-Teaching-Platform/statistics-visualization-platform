...
const dataDir = resolve(process.cwd(), "apps/regression/public/data/textbook");
...
describe("textbook regression datasets", () => {
  ...
  it("loads textbook datasets from the regression app bootstrap", () => {
    ...
    expect(mainSource).toContain("data/textbook/chapter-8-height-father-height.json");
    expect(mainSource).toContain("data/textbook/chapter-8-book-spending-income.json");
  });
});
