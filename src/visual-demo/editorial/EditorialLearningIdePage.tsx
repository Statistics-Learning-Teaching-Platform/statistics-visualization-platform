      ...
      <main id="main-content" className="ed-ide-page">
        <aside className="ed-course-folio">
          ...
          <nav aria-label={`${config.title}课程目录`}>
            {courseLessons.map(([number, title]) => {
              ...
              return (
                <a key={number} href="#lesson-title" data-current={active || undefined}>
                  <span>{number}</span>
                  <div>
          ...
          <section className="ed-code-cell">
            <header>
              <div>
                ...
                <span aria-hidden="true" />
                <span aria-hidden="true" />
                <strong>{config.kind === "r" ? "lesson-01.R" : "lesson-06.py"}</strong>
              </div>
          ...
          <section className="ed-check-cell" data-passed={hasRun || undefined}>
            <div>
              ...
              <span>
                ...
                <small>
                  {hasRun ? "对象与结果均符合本课目标。" : "运行代码后检查对象与结果。"}
                </small>
              </span>
            </div>
        ...
        <aside className="ed-tutor-rail">
          ...
          <section className="ed-review-note">
            ...
            <label>
              <span>你的回答</span>
              <input placeholder={config.kind === "r" ? "average_score" : "summary"} />
            </label>
          </section>
          <Button
