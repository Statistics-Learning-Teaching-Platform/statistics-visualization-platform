...
export const textbookDemoChapters: Record<string, TextbookDemoChapter> = {
	"06": {
		...
		lab: {
			...
			explanation:
				"选择不同样本量。图中的中心保持不变，标准误和误差界会随 n 增大而下降。",
			center: 10,
			sigma: 2,
			axisMin: 8,
			axisMax: 12,
		...
		exercises: [
			...
			},
			{
				...
				hint: "区分固定参数与随机区间。",
				answer:
					"经典框架下参数固定、区间随样本改变。95% 描述方法在重复抽样中的覆盖表现。",
			},
			{
				number: "04",
				...
				answer:
					"不一定。窄区间只说明随机误差较小，系统偏差、测量质量和抽样代表性仍需单独判断。",
			},
		],
	},
	"07": {
		...
		exercises: [
			...
			},
			{
				...
				answer:
					"使用配对方法。先计算每名学生的前后差值，再对差值进行单样本推断。",
			},
			{
				number: "03",
				...
				answer:
					"数据仍与零差异相容；现有样本不足以排除总体均值相同，但这不等于证明两者完全相同。",
			},
			{
				number: "04",
