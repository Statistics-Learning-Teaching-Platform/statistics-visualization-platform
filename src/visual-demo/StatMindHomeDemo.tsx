...
function EvidencePlot() {
  ...
  return (
    ...
    >
      ...
      <path className="sm-demo-evidence__grid" d="M38 175H330M60 27v148M180 27v148M300 27v148" />
      <path className="sm-demo-evidence__truth" d="M180 21v154" />
      <text x="188" y="19">
        真实均值 μ
      </text>
      {intervals.map((interval, index) => (
        <g key={interval.y} className={interval.covered ? "is-covered" : "is-missed"}>
          <text x="18" y={interval.y + 4}>
            {String(index + 1).padStart(2, "0")}
          </text>
          <path d={`M${interval.x1} ${interval.y}H${interval.x2}`} />
          <path d={`M${interval.x1} ${interval.y - 5}v10M${interval.x2} ${interval.y - 5}v10`} />
  ...
  return (
    <main className="sm-demo">
      ...
      <div className="sm-demo-shell">
        <section className="sm-demo-hero" aria-labelledby="sm-demo-title">
          <div className="sm-demo-hero__copy">
            ...
            <div className="sm-demo-hero__actions">
              ...
              <a className="sm-demo-button sm-demo-button--quiet" href="/catalog">
                浏览教材目录
              </a>
            </div>
          </div>
        ...
        <section className="sm-demo-workspaces" aria-labelledby="workspaces-title">
