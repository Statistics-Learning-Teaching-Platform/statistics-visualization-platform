export type KnowledgeNodeVariant = "root" | "concept" | "method" | "formula" | "note";
...
const chapterSeeds: Record<string, ChapterSeed> = {
  "00": {
          ...
          children: [
            ...
            node("00-sampling", "抽样", {
              ...
              explanation: {
                ...
                example:
                  "如果希望研究某大学全部学生的平均睡眠时间，可以随机抽取 500 名学生进行调查。",
              },
            }),
    ...
    extraEdges: [
      {
        id: "00-question-population",
        source: "statistics-foundations",
        target: "00-population-sample",
        relation: "leadsTo",
      },
      {
        id: "00-sample-data",
        source: "00-sample",
        target: "data-and-variables",
        relation: "leadsTo",
      },
      {
        id: "00-data-statistic",
        source: "data-and-variables",
        target: "00-statistic",
        relation: "leadsTo",
      },
      {
        id: "00-statistic-parameter",
        source: "00-statistic",
        target: "00-parameter",
        relation: "infer",
        label: "infer",
      ...
      {
        id: "00-estimate-infer",
        source: "00-estimation",
        target: "00-infer-population",
        relation: "infer",
      },
    ],
  },
  "01": {
    ...
    root: node("root", "抽样调查", {
      ...
      children: [
        ...
        node("01-error", "抽样误差", {
          topicId: "sampling-methods",
          variant: "note",
          children: [node("01-variation", "随机波动")],
        }),
        node("01-bias", "抽样偏差", {
          topicId: "sampling-methods",
          variant: "note",
          children: [node("01-undercoverage", "漏覆盖")],
        }),
    ...
    extraEdges: [
      {
        id: "01-population-frame",
        source: "01-population",
        target: "01-frame",
        relation: "leadsTo",
      },
      {
      ...
      {
        id: "01-sample-infer",
        source: "01-sample-data",
        target: "01-infer-population",
        relation: "infer",
      },
      {
        id: "01-design-representative",
        source: "sampling-methods",
        target: "01-representative",
        relation: "leadsTo",
      },
      {
        id: "01-bias-representative",
        source: "01-bias",
        target: "01-representative",
        relation: "dependsOn",
      },
    ...
    root: node("root", "数据的图形化描述", {
      ...
      children: [
        node("02-data", "数据", {
          ...
          children: [node("02-observation", "观测值"), node("02-table", "数据表")],
        }),
        ...
        node("02-distribution", "观察分布", {
          ...
          children: [
            ...
            node("02-spread", "离散"),
            node("02-skew", "偏态"),
            node("02-outlier", "异常值", { variant: "note" }),
          ],
        }),
        node("02-interpret", "解释数据", {
          topicId: "visual-encoding",
          variant: "note",
          children: [node("02-context", "回到问题情境", { variant: "note" })],
        }),
      ],
    }),
    extraEdges: [
      ...
      {
        id: "02-type-graph",
        source: "visual-encoding",
        target: "02-choose-graph",
        relation: "leadsTo",
      },
      {
        id: "02-graph-distribution",
        source: "02-choose-graph",
        target: "02-distribution",
        relation: "leadsTo",
      },
      {
        id: "02-distribution-interpret",
        source: "02-distribution",
        target: "02-interpret",
        relation: "infer",
      },
    ],
    ...
    root: node("root", "描述数据分布的数值特征", {
      ...
      children: [
        ...
        node("03-spread", "离散程度", {
          ...
          children: [
            node("03-range", "Range"),
            node("03-variance", "Variance"),
            node("03-sd", "Standard Deviation"),
            node("03-iqr", "IQR"),
          ],
        }),
        ...
        node("03-outliers", "异常值", {
          topicId: "descriptive-statistics",
          variant: "note",
          children: [node("03-robust", "稳健描述", { variant: "method" })],
        }),
        node("standardization", "标准化", {
          topicId: "standardization",
          variant: "method",
          children: [
            node("03-zscore", "Z = (X − mean) / SD", {
              variant: "formula",
              edgeRelation: "transform",
            }),
          ],
        }),
      ],
    ...
    root: node("root", "随机事件与概率", {
      ...
      children: [
        node("04-experiment", "随机试验", {
          ...
          variant: "method",
          children: [
            node("04-outcome", "随机结果"),
            node("04-space", "样本空间 Ω", { variant: "formula" }),
          ],
        }),
        node("probability-foundations", "事件", {
          topicId: "probability-foundations",
          children: [
            node("04-union", "并 A∪B", { variant: "formula" }),
            node("04-intersection", "交 A∩B", { variant: "formula" }),
            node("04-complement", "补 Aᶜ", { variant: "formula" }),
            node("04-disjoint", "互斥", { variant: "note" }),
          ],
        }),
        node("04-probability", "概率", {
          ...
          variant: "method",
          children: [
            node("04-addition", "加法公式", { variant: "formula" }),
            node("04-multiplication", "乘法公式", { variant: "formula" }),
            node("04-total", "全概率公式", { variant: "formula" }),
          ],
        }),
        node("04-conditional", "条件概率", {
          ...
          variant: "method",
          children: [
            node("04-conditional-formula", "P(A|B)", { variant: "formula" }),
            node("04-independent", "独立性", { variant: "note" }),
          ],
        }),
        node("04-random-variable", "随机变量 X", {
          topicId: "random-variables",
          variant: "concept",
          edgeRelation: "transform",
          children: [
            node("04-transform-result", "随机结果 → X", {
              variant: "formula",
              edgeRelation: "transform",
            }),
          ],
    ...
    extraEdges: [
      {
        id: "04-space-event",
        source: "04-space",
        target: "probability-foundations",
        relation: "leadsTo",
      },
      {
        id: "04-event-probability",
        source: "probability-foundations",
        target: "04-probability",
        relation: "leadsTo",
      },
    ],
  },
  "05": {
    ...
    root: node("root", "随机变量与概率分布", {
      ...
      children: [
        node("05-random-variable", "随机变量", {
          topicId: "probability-distributions",
          children: [
            node("05-discrete", "离散型", { variant: "method" }),
            node("05-continuous", "连续型", { variant: "method" }),
          ],
        }),
        node("probability-distributions", "离散分布", {
          topicId: "probability-distributions",
          children: [
            node("05-bernoulli", "Bernoulli"),
            node("05-binomial", "Binomial"),
            node("05-poisson", "Poisson"),
          ],
        }),
        node("normal-distribution", "连续分布", {
          topicId: "normal-distribution",
          children: [
            node("05-uniform", "Uniform"),
            node("05-normal", "Normal", {
              variant: "method",
              children: [
                node("05-mu", "μ"),
                node("05-sigma", "σ"),
                node("05-normal-formula", "X ~ N(μ, σ²)", {
                  variant: "formula",
                  children: [
                    node("05-z", "Z ~ N(0,1)", { variant: "formula", edgeRelation: "transform" }),
                  ],
                }),
              ],
            }),
        ...
        node("05-expectation", "期望 E(X)", {
          topicId: "probability-distributions",
          variant: "formula",
        }),
        node("05-variance", "方差 Var(X)", {
          topicId: "probability-distributions",
          variant: "formula",
        }),
        node("t-distribution", "t 分布", {
          topicId: "t-distribution",
          children: [node("05-df", "自由度", { variant: "note" })],
        }),
      ],
    }),
    extraEdges: [
      {
        id: "05-discrete-branch",
        source: "05-random-variable",
        target: "probability-distributions",
        relation: "leadsTo",
      },
      {
        id: "05-continuous-branch",
        source: "05-random-variable",
  ...
  "06": {
    ...
    root: node("root", "样本的统计推断", {
      ...
      children: [
        node("06-population", "总体 Parameter", {
          topicId: "point-estimation",
          variant: "concept",
          children: [node("06-mu-sigma", "μ / σ", { variant: "formula" })],
        }),
        node("06-sample", "样本 Statistic", {
          topicId: "sampling-distributions",
          variant: "concept",
          children: [node("06-xbar-s", "x̄ / s", { variant: "formula" })],
        }),
        ...
        node("central-limit-theorem", "中心极限定理", {
          ...
          variant: "method",
          children: [
            node("06-approx-normal", "Sample Mean → Approximately Normal", {
              variant: "formula",
              edgeRelation: "transform",
            }),
          ],
        ...
        node("06-se", "标准误 SE", {
          ...
          variant: "formula",
          children: [
            node("06-n-up", "n ↑", { variant: "note" }),
            node("06-se-down", "SE ↓", { variant: "note" }),
          ],
        }),
        node("06-inference", "统计推断", {
          topicId: "point-estimation",
          variant: "method",
          children: [node("06-stable", "估计稳定性 ↑", { variant: "note" })],
        }),
      ],
    }),
    extraEdges: [
      {
        id: "06-population-sample",
        source: "06-population",
        target: "06-sample",
        relation: "compare",
      },
      {
        id: "06-sample-distribution",
        source: "06-sample",
        target: "sampling-distributions",
        relation: "leadsTo",
      },
      {
        id: "06-distribution-clt",
        source: "sampling-distributions",
  ...
  "07": {
    ...
    root: node("root", "总体均值的比较", {
      ...
      children: [
        node("07-question", "研究问题", {
          topicId: "hypothesis-testing",
          children: [
            node("07-one-sample", "单样本"),
            node("07-independent", "独立双样本"),
            node("07-paired", "配对样本"),
          ],
        }),
        ...
        node("type-i-type-ii-errors", "错误", {
          topicId: "type-i-type-ii-errors",
          variant: "note",
          children: [
            node("07-type-i", "Type I Error α", { variant: "formula" }),
            node("07-type-ii", "Type II Error β", { variant: "formula" }),
          ],
        }),
  ...
  "08": {
    ...
    root: node("root", "相关与回归分析", {
      ...
      children: [
        node("08-two-vars", "两个定量变量", {
          topicId: "correlation",
          children: [
            node("08-x", "X · 解释变量", { variant: "concept" }),
            node("08-y", "Y · 响应变量", { variant: "concept" }),
          ],
        }),
        node("correlation", "散点图与 Correlation", {
          topicId: "correlation",
          variant: "method",
          children: [node("08-scatter", "散点图"), node("08-correlation", "Correlation")],
        }),
        node("linear-regression", "Linear Regression", {
          topicId: "linear-regression",
          variant: "method",
          children: [
            node("08-intercept", "β₀ · Intercept", { variant: "formula" }),
            node("08-slope", "β₁ · Slope", { variant: "formula" }),
            node("08-error", "ε · Random Error", { variant: "formula" }),
          ],
        }),
        node("08-equation", "Y = β₀ + β₁X + ε", {
          topicId: "linear-regression",
          variant: "formula",
        }),
        ...
        node("08-diagnosis", "Model Diagnosis", {
          topicId: "linear-regression",
          variant: "method",
        }),
        node("08-causation", "Correlation ≠ Causation", {
          topicId: "correlation",
          variant: "note",
        }),
      ],
    ...
    extraEdges: [
      ...
      {
        id: "08-correlation-regression",
        source: "correlation",
        target: "linear-regression",
        relation: "leadsTo",
      },
      {
        id: "08-model-equation",
        source: "linear-regression",
        target: "08-equation",
        relation: "transform",
      },
      {
        id: "08-equation-prediction",
        source: "08-equation",
        target: "08-prediction",
        relation: "leadsTo",
      },
      {
        id: "08-prediction-residual",
        source: "08-prediction",
        target: "08-residual",
        relation: "leadsTo",
      },
      {
        id: "08-residual-diagnosis",
        source: "08-residual",
        target: "08-diagnosis",
        relation: "infer",
      },
      {
        id: "08-correlation-causation",
        source: "correlation",
        target: "08-causation",
        relation: "dependsOn",
      },
  ...
  "09": {
    ...
    root: node("root", "拟合优度检验与列联表分析", {
      ...
      children: [
        ...
        node("chi-square-test", "χ² statistic", {
          topicId: "chi-square-test",
          variant: "formula",
          children: [node("09-formula", "χ² = Σ (O−E)² / E", { variant: "formula" })],
        }),
        node("09-pvalue", "P-value", { topicId: "chi-square-test", variant: "formula" }),
        node("09-goodness", "Goodness of Fit", {
          topicId: "chi-square-test",
          variant: "method",
          children: [node("09-one-cat", "一个分类变量")],
        }),
        node("09-independence", "Independence Test", {
          topicId: "chi-square-test",
          variant: "method",
          children: [
            node("09-two-cat", "两个分类变量"),
            node("09-table", "列联表", { variant: "concept" }),
          ],
        }),
      ],
    }),
    extraEdges: [
      {
        id: "09-observed-expected",
        source: "09-observed",
        target: "09-expected",
        relation: "compare",
      },
      {
        id: "09-expected-difference",
        source: "09-expected",
        target: "09-difference",
        relation: "leadsTo",
      },
      {
        id: "09-difference-chi",
        source: "09-difference",
        target: "chi-square-test",
        relation: "transform",
      },
      ...
      {
        id: "09-chi-independence",
        source: "chi-square-test",
        target: "09-independence",
        relation: "contains",
      },
    ],
  },
  "10": {
    ...
    root: node("root", "不依赖于分布的统计推断", {
      ...
      children: [
        node("10-nonparametric", "非参数方法", {
          topicId: "nonparametric-tests",
          variant: "method",
          children: [node("10-rank", "秩"), node("10-empirical", "经验分布")],
        }),
        node("bootstrap-and-permutation", "Bootstrap", {
          topicId: "bootstrap-and-permutation",
          variant: "method",
          children: [
            node("10-original", "Original Sample"),
            node("10-resample", "Resample WITH Replacement", { variant: "method" }),
            node("10-bootstrap-samples", "Bootstrap Samples"),
            node("10-bootstrap-stat", "Statistic", { variant: "formula" }),
            node("10-bootstrap-dist", "Bootstrap Distribution"),
            node("10-se-ci", "SE / CI", { variant: "formula" }),
          ],
        }),
        node("10-permutation", "Permutation", {
          ...
          variant: "method",
          children: [
            node("10-null", "H₀", { variant: "formula" }),
            node("10-shuffle", "Shuffle Labels", { variant: "method" }),
            node("10-recalculate", "Recalculate Statistic", { variant: "formula" }),
            node("10-repeat", "Repeat"),
            node("10-null-dist", "Null Distribution"),
            node("10-p", "P-value", { variant: "formula" }),
          ],
        }),
      ],
    }),
    extraEdges: [
      {
        id: "10-bootstrap-original",
        source: "10-original",
        target: "10-resample",
        relation: "leadsTo",
      },
      {
        id: "10-resample-samples",
        source: "10-resample",
        target: "10-bootstrap-samples",
        relation: "leadsTo",
      },
      {
        id: "10-samples-stat",
        source: "10-bootstrap-samples",
        target: "10-bootstrap-stat",
        relation: "leadsTo",
      },
      {
        id: "10-stat-dist",
        source: "10-bootstrap-stat",
        target: "10-bootstrap-dist",
        relation: "leadsTo",
      },
      ...
      {
        id: "10-shuffle-recalc",
        source: "10-shuffle",
        target: "10-recalculate",
        relation: "leadsTo",
      },
      {
        id: "10-recalc-repeat",
        source: "10-recalculate",
        target: "10-repeat",
        relation: "leadsTo",
      },
  ...
  "11": {
    ...
    root: node("root", "时间序列分析", {
      ...
      children: [
        node("time-series", "Time Series", {
          topicId: "time-series",
          variant: "method",
          children: [
            node("11-y-t", "Yₜ", { variant: "formula" }),
            node("11-y-lag", "Yₜ₋₁ / Yₜ₋₂", { variant: "formula", edgeRelation: "dependsOn" }),
          ],
        }),
        node("11-historical-data", "Historical Data", {
          topicId: "time-series",
          children: [node("11-temporal-pattern", "Temporal Pattern", { variant: "concept" })],
        }),
        node("time-trend", "Trend", {
          topicId: "time-series",
          children: [node("11-long-term", "长期方向")],
        }),
        node("11-seasonality", "Seasonality", {
          topicId: "time-series",
          children: [node("11-periodic", "周期性重复")],
        }),
        node("11-cycle", "Cycle", {
          topicId: "time-series",
          children: [node("11-expansion", "扩张与收缩")],
        }),
        node("11-noise", "Noise", {
          topicId: "time-series",
          variant: "note",
          children: [node("11-random", "随机波动")],
        }),
        node("11-autocorrelation", "Autocorrelation", {
          topicId: "time-series",
          variant: "method",
        }),
        node("11-forecasting", "Forecasting", {
          topicId: "time-series",
          variant: "method",
          children: [
            node("11-model", "Model", { variant: "method" }),
            node("11-forecast", "Forecast", { variant: "formula" }),
          ],
        }),
      ],
    }),
    extraEdges: [
      ...
      {
        id: "11-lag-autocorrelation",
        source: "11-y-lag",
        target: "11-autocorrelation",
        relation: "dependsOn",
      },
      {
        id: "11-history-pattern",
        source: "time-series",
        target: "11-forecasting",
        relation: "leadsTo",
      },
    ],
  },
