  ...
  examples: [
    {
      ...
      description:
        "Compare a fixed reference curve with the current normal distribution, switch between PDF/PMF and CDF/CMF views, and calculate interval probabilities.",
      teachingPoints: [
      ...
      quickActions: [
        {
          ...
          control: "a",
          amount: 1,
          copyKey: "changeMeanOnly",
          showWhen: { controlId: "dist", values: ["norm"] },
        },
        {
          type: "bumpControl",
          control: "b",
          amount: 0.5,
          copyKey: "changeSdOnly",
          showWhen: { controlId: "dist", values: ["norm"] },
        },
      ],
      controls: [
