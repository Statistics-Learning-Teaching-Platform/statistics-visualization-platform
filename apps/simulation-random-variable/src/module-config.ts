  ...
  examples: [
    {
      ...
      description:
        "Generate a normal sample and compare its simulated histogram with the target center.",
      teachingPoints: [
    ...
    },
    {
      ...
      sourcePath: "apps/simulation-random-variable/src/module-config.ts",
      description:
        "Generate exponential data and examine how the rate parameter controls the tail.",
      teachingPoints: [
    ...
    },
    {
      ...
      sourcePath: "apps/simulation-random-variable/src/module-config.ts",
      description:
        "Sample from a gamma target by accepting uniform proposals with probability proportional to the gamma density.",
      teachingPoints: [
