  ...
  examples: [
    {
      ...
      description:
        "Resample the observed values with replacement and study the bootstrap distribution of the sample maximum.",
      teachingPoints: [
    ...
    },
    {
      ...
      sourcePath: "apps/simulation-resampling/src/module-config.ts",
      description:
        "Test a difference in two means by repeatedly shuffling group labels under the null hypothesis.",
      teachingPoints: [
