...
export const confidenceIntervalCopy = {
  zh: {
    ...
    sampleIndex: "样本序号",
    chartAriaDescription: "绿色区间覆盖真实均值，红色区间未覆盖；每个圆点表示一个样本均值。",
    sampleTooltip: "样本 {number}：{lower} 到 {upper}；{coverage}真实均值",
    tooltipCovers: "覆盖",
    tooltipMisses: "未覆盖",
    ...
    populationMeanHint: "移动真实参数，观察区间是否覆盖它。",
    populationSD: "总体标准差",
...
export const walsCopy = {
  zh: {
    ...
    run100Samples: "运行 100 次",
    simulate100: "模拟 100 次",
    simulate1000: "模拟 1000 次",
    generateOneInterval: "生成 1 个区间",
    generateTwentyIntervals: "生成 20 个区间",
    reset: "重置",
    setN1: "比较 n = 1",
    setN5: "比较 n = 5",
    setN30: "比较 n = 30",
    setN100: "比较 n = 100",
    changeMeanOnly: "只改变均值",
    changeSdOnly: "只改变标准差",
  },
  en: {
    modelOutput: "Model output",
    ...
    run100Samples: "Run 100",
    simulate100: "Simulate 100",
    simulate1000: "Simulate 1000",
    generateOneInterval: "Generate 1 interval",
    generateTwentyIntervals: "Generate 20 intervals",
    reset: "Reset",
    setN1: "Compare n = 1",
    setN5: "Compare n = 5",
    setN30: "Compare n = 30",
    setN100: "Compare n = 100",
    changeMeanOnly: "Change Mean Only",
    changeSdOnly: "Change SD Only",
  },
} as const;
...
export const typeErrorCopy = {
  zh: {
    ...
    pValue: "p 值",
    pValueNote: "在 H₀ 成立时，得到当前或更极端统计量的概率。",
    testDecision: "检验决策",
    rejectNull: "拒绝 H₀",
    failToRejectNull: "不拒绝 H₀",
    decisionNote: "比较 p 值与显著性水平 α；不拒绝不等于接受 H₀。",
    parameters: "参数",
    hypothesis: "假设形式",
    oneSided: "单边",
    leftTailed: "左尾",
    ...
    sampleSizeLabel: "样本量 n",
    sampleSizeHint: "样本量越大，标准误越小，检验通常越有功效。",
    observedStatistic: "观测检验统计量",
    observedStatisticHint: "移动观测统计量，观察 p 值和检验决策如何变化。",
    conceptKeyIdea: "概念 + 核心思想",
    ...
    oneSidedTest: "单边检验",
    leftTailedTest: "左尾检验",
    rightTailedTest: "右尾检验",
    twoSidedTest: "双边检验",
    pValueWarning: "p 值不是原假设为真的概率，也不是结果由随机造成的概率。",
    and: "和",
  },
  en: {
    coreVisualizer: "Core Visualizer",
    ...
    pValue: "p value",
    pValueNote: "Under H₀, the probability of a statistic at least as extreme as the observed one.",
    testDecision: "Test decision",
    rejectNull: "Reject H₀",
    failToRejectNull: "Fail to reject H₀",
    decisionNote: "Compare p with alpha; failing to reject does not mean accepting H₀.",
    parameters: "Parameters",
    hypothesis: "Hypothesis",
    oneSided: "One-sided",
    leftTailed: "Left tail",
    ...
    sampleSizeLabel: "Sample size n",
    sampleSizeHint: "Larger samples reduce the standard error and usually increase power.",
    observedStatistic: "Observed test statistic",
...
export const regressionCopy = {
  zh: {
    ...
    customLineParameters: "自定义直线参数",
    numericLineHint: "输入斜率和截距，也可以替代拖动直线。",
    slope: "斜率",
    intercept: "截距",
  ...
  en: {
    ...
    customLineParameters: "Custom line parameters",
    numericLineHint: "Type slope and intercept as an alternative to dragging the line.",
    slope: "Slope",
    intercept: "Intercept",
