...
export function VisualizationTabs({
  ...
  return (
    <section className="visualization-tabs" data-visualization-tabs="true">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="visualization-tabs__tab"
              data-active={String(tab.id === active?.id)}
      ...
      <div
        id={active ? `${instanceId}-panel-${active.id}` : undefined}
        className="visualization-tabs__panel"
        role="tabpanel"
        aria-labelledby={active ? `${instanceId}-tab-${active.id}` : undefined}
      >
        {active?.content}
      </div>
    </section>
