  ...
  examples: [
    {
      ...
      description:
        "Draw repeated random samples and build a z- or t-interval from each, then watch how often they cover the true mean.",
      teachingPoints: [
      ...
      quickActions: [
        {
          ...
          amount: 1,
          copyKey: "generateOneInterval",
        },
        {
          type: "runWithControl",
          control: "intervalCount",
          amount: 20,
          copyKey: "generateTwentyIntervals",
        },
